...
def generate_launch_description():
    ...
    bridge_node = Node(
        ...
        executable='global_map_bridge_node',
        name='global_map_bridge',
        output='screen',
        parameters=[{
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'processing_config',
            default_value=os.path.join(package_dir, 'config', 'pcl_parameters.yaml'),
            description='Path to the grid_map_pcl processing configuration file.'),
        DeclareLaunchArgument(
            'visualization_config',
            default_value=os.path.join(package_dir, 'config', 'global_map_visualization.yaml'),
            description='Path to the grid_map_visualization configuration file.'),
        DeclareLaunchArgument(
            'input_topic',
            default_value='/grit_slam/global_map',
